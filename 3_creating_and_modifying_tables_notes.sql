...
-- Select all from table directors to view data
...
CREATE TABLE movies(
	...
	release_date DATE,
	-- Create a foreign key to link movies and directors table
	-- key, type, REFERENCES, foreign table, foreign column name
	director_id INT REFERENCES directors (director_id)
);
-- Select all from table directors to view data
SELECT * FROM movies;

-- Create the Movies Revenue table
CREATE TABLE movies_revenues(
	revenue_id SERIAL PRIMARY KEY,
	-- Create a foreign key to link movies_revenues and movies table
	-- key, type, REFERENCES, foreign table, foreign column name
...
-- Creating a Junction table movies_actors
CREATE TABLE movies_actors(
	-- Create 2 foreign key references to link movies and actors table by means of their primary key
	-- key, type, REFERENCES, foreign table, foreign column name
	movie_id INT REFERENCES movies (movie_id),
...
-- Insert sample records into the directors table
-- ---------------------------------------------------
...
-- Insert sample records into the actors table
-- ---------------------------------------------------
...
-- Insert sample records into the movies_actors table
-- ---------------------------------------------------------
...
-- Insert sample records into the movies_revenues table
-- ---------------------------------------------------------
